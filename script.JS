...
const basicsQuest = [
  {
    ...
    answers: [
      "You can set the width and height properties of inline elements, but generally can't set the width and height properties of block elements.",
      "Block elements take up the whole width of the screen, while inline elements stack next to each other and only take up the width that they need.",
      "Inline elements take up the whole width of the screen, while block elements stack next to each other and only take up the width that they need.",
    ],
    corAnswer: 1,
  },
  {
  ...
  {
    question: `Why is JS still able to do comparisons when using a string on one end of the operator and a number on the other end?`,
    answers: [
      `Because JS applies type coercion.`,
      `JS is not able to do that.`,
      `Because JS applies type conversion.`,
    ],
    corAnswer: 0,
  },
  {
...
console.log(basicsQuest.length);

// TODO: FUNCTIONS
const functionsQuest = [
  {
...
console.log(functionsQuest.length);
...
const arrayQuest = [
  ...
  {
    question: `How do you destructure array items into variables?`,
    answers: [
      `[newVar1, newVar2, newVar3] = arrayName`,
      `const [newVar1, newVar2, newVar3] = arrayName`,
      `[newVar1, newVar2, newVar3] = [arrayName]`,
    ],
    corAnswer: 1,
  },
  {
    question: `How do you skip an array item when destructuring an array?`,
    answers: [
      `const [newVar1, / , newVar3] = arrayName`,
      `[newVar1, , newVar3] = arrayName`,
      `const [newVar1, , newVar3] = arrayName`,
    ],
    corAnswer: 2,
  },
  {
    question: `How do you destructure nested array items 2 and 3? const arrayName = [1, [2, 3]]`,
    answers: [
  ...
  {
    question: `How do you give variables default values when you don't know how many array items an array has?`,
    answers: [
      `const [newVar1: 0, newVar2: 0, newVar3: 0] = arrayName`,
      `const [newVar1 = 0, newVar2 = 0, newVar3 = 0] = arrayName`,
      `[newVar1: 0, newVar2: 0, newVar3: 0] = arrayName`,
    ],
    corAnswer: 1,
  },
];
console.log(arrayQuest.length);
...
const objectQuest = [
  ...
  {
    question: `How do you copy an object into a new object?`,
    answers: [
  ...
  {
    question: `How do you destructure object properties into variables that have the same name as the properties?`,
    answers: [
      `const {prop1, prop2, prop3} = objectName`,
      `const {prop1: newVar1, prop2: newVar2, prop3: newVar3} = objectName`,
      `const {prop1: newVar1 = 0, prop2: newVar2 = 1, prop3: newVar3 = 2} = objectName`,
    ],
    corAnswer: 0,
  },
  {
    question: `How do you destructure object properties into variables with variable names different than the property names?`,
    answers: [
      `const {prop1, prop2, prop3} = objectName`,
      `const {prop1: newVar1, prop2: newVar2, prop3: newVar3} = objectName`,
      `const {prop1: newVar1 = 0, prop2: newVar2 = 1, prop3: newVar3 = 2} = objectName`,
  ...
  {
    question: `How do you give default values to the destructured object properties?`,
    answers: [
      `const {prop1, prop2, prop3} = objectName`,
      `const {prop1: newVar1, prop2: newVar2, prop3: newVar3} = objectName`,
      `const {prop1: newVar1 = 0, prop2: newVar2 = 1, prop3: newVar3 = 2} = objectName`,
...
const engineQuest = [
  ...
  {
    question: "Where do primitive datatypes get stored?",
    answers: [`Callstack`, `Memory heap`, `Drive C`],
    corAnswer: 0,
  },
  {
    question: "Where do reference datatypes get stored?",
    answers: [`Callstack`, `Memory heap`, `Drive C`],
    corAnswer: 1,
  },
];
console.log(engineQuest.length);
...
// adding a comment so I can commit something on my git repo
// adding another comment so I can see if GitBash sees that I changed something lol
